...
(function () {
  ...
  const CHARS = {
    ...
    commander: { type: 'commander', icon: '/assets/icons/commander.png', name: '지휘관',     tier: 3, atk: 1, baseHp: 4 },
    princess:  { type: 'princess',  icon: '/assets/icons/princess.png',  name: '공주',       tier: 3, atk: 2, baseHp: 3 },
  ...
  const TUT_CHARS_DATA = {
    ...
    2: [
      ...
      { type:'witch',           name:'마녀',       tier:2, atk:0, icon:'/assets/icons/witch.png',  tag:'villain',
    ...
    3: [
      { type:'prince',        name:'왕자',         tier:3, atk:2, icon:'/assets/icons/prince.png', tag:'royal',   skills:[] },
      { type:'princess',      name:'공주',         tier:3, atk:2, icon:'/assets/icons/princess.png', tag:'royal',   skills:[] },
      { type:'king',          name:'국왕',         tier:3, atk:3, icon:'/assets/icons/king.png', tag:'royal',
      ...
      { type:'commander',     name:'지휘관',       tier:3, atk:1, icon:'/assets/icons/commander.png',  tag:'royal',   skills:[], passives:['wrath'] },
      ...
      { type:'count',         name:'백작',         tier:3, atk:1, icon:'/assets/icons/count.png',  tag:'villain', skills:[], passives:['tyranny'] },
    ],
  };
