...
(function () {
  ...
  window.PIECE_GIFS = {
    ...
    siegeBreaker:   '/art/siegeBreaker_idle.gif',
    courtier:       '/art/courtier_idle.gif',
    griffin:        '/art/griffin_idle.gif',
    thief:          '/art/thief_idle.gif',
    poisoner:       '/art/poisoner_idle.gif',
    dryad:          '/art/dryad_idle.gif',
    demonKing:      '/art/demonKing_idle.gif',
    mushkin:        '/art/mushkin_idle.gif',
    gravekeeper:    '/art/gravekeeper_idle.gif',
    militia:        '/art/militia_idle.gif',
    wanderer:       '/art/wanderer_idle.gif',
    mermaid:        '/art/mermaid_idle.gif',
    necromancer:    '/art/necromancer_idle.gif',
    ...
    heretic:        '/art/heretic_idle.gif',
    storyteller:    '/art/storyteller_idle.gif',
    executioner:    '/art/executioner_idle.gif',
    ironman:        '/art/ironman_idle.gif',
    catapult:       '/art/catapult_idle.gif',
    fortuneTeller:  '/art/fortuneTeller_idle.gif',
    homunculus:     '/art/homunculus_idle.gif',
  };
